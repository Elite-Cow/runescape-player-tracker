...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-[#0a1028] p-1 text-[#888888] border border-[#1a2048]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#c8a84b]/20 data-[state=active]:to-[#c8a84b]/10 data-[state=active]:text-[#c8a84b] data-[state=active]:shadow-sm data-[state=active]:border data-[state=active]:border-[#c8a84b]/30",
      "hover:text-[#e0e0e0]",
      className
    )}
    {...props}
